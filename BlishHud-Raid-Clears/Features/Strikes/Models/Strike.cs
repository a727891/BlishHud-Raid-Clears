...
public class Strike : GroupModel
{
    ...
    public Strike(ExpansionStrikes expansion) : base(expansion.Name, expansion.Id, 0, Service.StrikeSettings.GetEncounterLabel(expansion.Id), expansion.GetEncounters())
    {
        Expansion = expansion;
    }
